# source
# https://github.com/bulletphysics/bullet3/blob/master/examples/pybullet/examples/kuka_with_cube.py
# 07 June 2019
...
logId1 = p.startStateLogging(
    p.STATE_LOGGING_GENERIC_ROBOT, "LOG0001.txt", [0, 1, 2])
