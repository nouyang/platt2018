...
def ABSE(a, b): return abs(a-b)


yPrev = 0
shoulderPanJoint = joints["shoulder_pan_joint"]
shoulderPoseDq = deque(
    np.arange(shoulderPanJoint.lowerLimit, shoulderPanJoint.upperLimit, 0.1))
try:
    flag = True
